...
class OnlineLicenseController extends mController{	
	function post(){
		$param = get_inputs();
		...
		$my_data['dns_name']='license.sec-inside.com';	
		...
		$options = array(
			'http' => array(
				...
				'header' => "Content-type:application/x-www-form-urlencoded\r\n"
							."Host: license.sec-inside.com\r\n"
			)
		);
		$context = stream_context_create($options);

		$url='http://'.$myip.'/activation/bindLicense.do?sn='.$sn.'&licenseKey='.$licenseKey;
