...
/**
 * @api {GET} /api/arp-static  获取ARP表中静态IPMAC地址绑定表项
...
/**
 * @api {POST} /api/arp-static  添加静态IPMAC地址绑定表项
...
/**
 * @api {PUT} /api/arp-static 修改静态IPMAC地址绑定表项
...
/**
 * @api {DELETE} /api/arp-static 删除静态IPMAC地址绑定表项
...
class ArpStaticController extends mController{
	public $module = 'ip_mac_bind';
}
