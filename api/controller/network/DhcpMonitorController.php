...
/**
 * @api {GET}  /api/dhcp-monitor 查看DHCP客户端信息，包含IP地址、MAC地址、租赁起始时间
 * @apiName 查看DHCP客户端信息，包含IP地址、MAC地址、租赁起始时间
 * @apiGroup DHCP
 *
 *
...
class DhcpMonitorController extends mController{
	public $module = 'dhcp_ipstatus';
}
