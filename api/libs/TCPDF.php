<?php
namespace lib;
use lib\TCPDF_STATIC;
use lib\TCPDF_FONTS;
use lib\TCPDF_FONT_DATA;
use lib\TCPDF_IMAGES;
...
class TCPDF {
	...
	public function write1DBarcode($code, $type, $x='', $y='', $w='', $h='', $xres='', $style='', $align='') {
		...
		require_once(dirname(__FILE__).'/jpgraph/tcpdf_barcodes_1d.php');
		// save current graphic settings
		$gvars = $this->getGraphicVars();
	...
	public function write2DBarcode($code, $type, $x='', $y='', $w='', $h='', $style='', $align='', $distort=false) {
		...
		require_once(dirname(__FILE__).'/jpgraph/tcpdf_barcodes_2d.php');
		// save current graphic settings
		$gvars = $this->getGraphicVars();
		// create new barcode object
