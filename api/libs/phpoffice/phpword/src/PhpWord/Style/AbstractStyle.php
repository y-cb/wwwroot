 ...
 * Class AbstractStyle
 *
 * @package lib\phpoffice\phpword\src\PhpWord\Style
 */
abstract class AbstractStyle
{
     ...
     *
     * @param \lib\phpoffice\phpword\src\PhpWord\Style\AbstractStyle $substyleObject
    ...
    protected function setObjectVal($value, $styleName, &$style)
    {
        ...
        if (is_array($value)) {
            /** @var \lib\phpoffice\phpword\src\PhpWord\Style\AbstractStyle $style Type hint */
