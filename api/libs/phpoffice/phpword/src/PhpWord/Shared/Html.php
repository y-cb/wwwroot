...
namespace lib\phpoffice\phpword\src\PhpWord\Shared;

use lib\phpoffice\phpword\src\PhpWord\Element\AbstractContainer;
use lib\phpoffice\phpword\src\PhpWord\Element\Row;
use lib\phpoffice\phpword\src\PhpWord\Element\Table;
use lib\phpoffice\phpword\src\PhpWord\Settings;
use lib\phpoffice\phpword\src\PhpWord\SimpleType\Jc;
use lib\phpoffice\phpword\src\PhpWord\SimpleType\NumberFormat;
...
class Html
{
     ...
     *
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\AbstractContainer $element Where the parts need to be added
     ...
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\AbstractContainer $element object to add an element corresponding with the node
     ...
     *
     * @param \DOMNode $node
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\AbstractContainer $element
     * @param array $styles
     * @param array $data
     */
     ...
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\AbstractContainer $element
     * @param array &$styles
     * @return \lib\phpoffice\phpword\src\PhpWord\Element\TextRun
     */
     ...
     *
     * @param \DOMNode $node
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\Table $element
     * @param array &$styles
     * @return Row $element
     */
     ...
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\Table $element
     * @param array &$styles
     * @return \lib\phpoffice\phpword\src\PhpWord\Element\Cell|\lib\phpoffice\phpword\src\PhpWord\Element\TextRun $element
     */
     ...
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\AbstractContainer $element
     *
     * @return \lib\phpoffice\phpword\src\PhpWord\Element\Image
     **/
