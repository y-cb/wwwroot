...
namespace lib\phpoffice\phpword\src\PhpWord\Writer\ODText\Element;
...
class Table extends AbstractElement
{
    ...
    public function write()
    {
        ...
        if (!$element instanceof \lib\phpoffice\phpword\src\PhpWord\Element\Table) {
            return;
        }
    ...
    private function writeRow(XMLWriter $xmlWriter, RowElement $row)
    {
        ...
        /** @var $row \lib\phpoffice\phpword\src\PhpWord\Element\Row Type hint */
