...
namespace lib\phpoffice\phpword\src\PhpWord\Writer\ODText\Part;

use lib\phpoffice\common\src\Common\XMLWriter;
use lib\phpoffice\phpword\src\PhpWord\Element\AbstractContainer;
use lib\phpoffice\phpword\src\PhpWord\Element\Image;
use lib\phpoffice\phpword\src\PhpWord\Element\Table;
use lib\phpoffice\phpword\src\PhpWord\Element\Text;
use lib\phpoffice\phpword\src\PhpWord\Element\TextRun;
use lib\phpoffice\phpword\src\PhpWord\Element\TrackChange;
...
use lib\phpoffice\phpword\src\PhpWord\Style\Table as TableStyle;
use lib\phpoffice\phpword\src\PhpWord\Writer\ODText\Element\Container;
use lib\phpoffice\phpword\src\PhpWord\Writer\ODText\Style\Paragraph as ParagraphStyleWriter;
...
class Content extends AbstractPart
{
     ...
     * @since 0.11.0
     *
     * @param \lib\phpoffice\common\src\Common\XMLWriter $xmlWriter
     */
    private function writeAutoStyles(XMLWriter $xmlWriter)
    {
        ...
        foreach ($this->autoStyles as $element => $styles) {
            ...
            foreach ($styles as $style) {
                /** @var \lib\phpoffice\phpword\src\PhpWord\Writer\ODText\Style\AbstractStyle $styleWriter Type hint */
     ...
     *
     * @param \lib\phpoffice\phpword\src\PhpWord\PhpWord $phpWord
     */
     ...
     *
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\AbstractContainer $container
    ...
    private function getContainerStyle($container, &$paragraphStyleCount, &$fontStyleCount)
    {
        ...
        foreach ($elements as $element) {
            if ($element instanceof TextRun) {
                ...
                /** @var \lib\phpoffice\phpword\src\PhpWord\Style\Table $style */
                $style = $element->getStyle();
                if ($style === null) {
     ...
     *
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\Text $element
     * @param int $paragraphStyleCount
     * @param int $fontStyleCount
     */
     ...
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\AbstractElement[] $trackedChanges
     */
