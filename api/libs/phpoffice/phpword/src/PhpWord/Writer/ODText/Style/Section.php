...
namespace lib\phpoffice\phpword\src\PhpWord\Writer\ODText\Style;
...
class Section extends AbstractStyle
{
    ...
    {
        /** @var \lib\phpoffice\phpword\src\PhpWord\Style\Section $style Type hint */
        $style = $this->getStyle();
        if (!$style instanceof \lib\phpoffice\phpword\src\PhpWord\Style\Section) {
            return;
        }
