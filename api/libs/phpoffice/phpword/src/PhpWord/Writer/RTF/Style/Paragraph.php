...
namespace lib\phpoffice\phpword\src\PhpWord\Writer\RTF\Style;
...
class Paragraph extends AbstractStyle
{
    ...
    {
        $style = $this->getStyle();
        if (!$style instanceof \lib\phpoffice\phpword\src\PhpWord\Style\Paragraph) {
            return '';
        }
     ...
     *
     * @param null|\lib\phpoffice\phpword\src\PhpWord\Style\Indentation $indent
     * @return string
     */
    private function writeIndentation($indent = null)
    {
        if (isset($indent) && $indent instanceof \lib\phpoffice\phpword\src\PhpWord\Style\Indentation) {
     ...
     * Writes tabs
     *
     * @param \lib\phpoffice\phpword\src\PhpWord\Style\Tab[] $tabs
     * @return string
     */
