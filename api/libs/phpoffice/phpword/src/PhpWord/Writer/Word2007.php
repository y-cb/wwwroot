...
namespace lib\phpoffice\phpword\src\PhpWord\Writer;

use lib\phpoffice\phpword\src\PhpWord\Element\Section;
use lib\phpoffice\phpword\src\PhpWord\Media;
...
class Word2007 extends AbstractWriter implements WriterInterface
{
     ...
     *
     * @param \lib\phpoffice\phpword\src\PhpWord\PhpWord
     */
    public function __construct(PhpWord $phpWord = null)
    {
        ...
        foreach (array_keys($this->parts) as $partName) {
            ...
            if (class_exists($partClass)) {
                /** @var \lib\phpoffice\phpword\src\PhpWord\Writer\Word2007\Part\AbstractPart $part Type hint */
                $part = new $partClass();
     ...
     *
     * @param \lib\phpoffice\phpword\src\PhpWord\Shared\ZipArchive $zip
        ...
        if (!empty($elements)) {
            foreach ($elements as $file => $media) {
                if (count($media) > 0) {
                    ...
                    /** @var \lib\phpoffice\phpword\src\PhpWord\Writer\Word2007\Part\AbstractPart $writerPart Type hint */
     ...
     *
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\Section &$section
     * @param \lib\phpoffice\phpword\src\PhpWord\Shared\ZipArchive $zip
    ...
    private function addHeaderFooterContent(Section &$section, ZipArchive $zip, $elmType, &$rId)
    {
        ...
        /** @var \lib\phpoffice\phpword\src\PhpWord\Element\AbstractElement $element Type hint */
    ...
    private function addNotes(ZipArchive $zip, &$rId, $noteType = 'footnote')
    {
        ...
        /** @var \lib\phpoffice\phpword\src\PhpWord\Collection\AbstractCollection $collection Type hint */
    ...
    private function addChart(ZipArchive $zip, &$rId)
    {
        ...
        $index = 0;
        if ($collection->countItems() > 0) {
            /** @var \lib\phpoffice\phpword\src\PhpWord\Element\Chart $chart */
