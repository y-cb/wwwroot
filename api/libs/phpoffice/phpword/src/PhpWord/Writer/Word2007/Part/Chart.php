...
use lib\phpoffice\phpword\src\PhpWord\Element\Chart as ChartElement;
...
class Chart extends AbstractPart
{
     ...
     * Chart element
     *
     * @var \lib\phpoffice\phpword\src\PhpWord\Element\Chart
     */
    private $element;
     ...
     * Set chart element.
     *
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\Chart $element
     */
    ...
    private function writeSeriesItem(XMLWriter $xmlWriter, $type, $values)
    {
        ...
        foreach ($values as $value) {
            ...
            if (\lib\phpoffice\phpword\src\PhpWord\Settings::isOutputEscapingEnabled()) {
