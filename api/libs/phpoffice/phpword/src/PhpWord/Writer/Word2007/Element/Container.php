...
use lib\phpoffice\phpword\src\PhpWord\Element\AbstractContainer as ContainerElement;
use lib\phpoffice\phpword\src\PhpWord\Element\AbstractElement as Element;
use lib\phpoffice\phpword\src\PhpWord\Element\TextBreak as TextBreakElement;
...
class Container extends AbstractElement
{
     ...
     * @var string
     */
    protected $namespace = 'lib\\phpoffice\\PhpWord\\Writer\\Word2007\\Element';
    ...
    public function write()
    {
        ...
        if ($writeLastTextBreak) {
            ...
            /** @var \lib\phpoffice\phpword\src\PhpWord\Writer\Word2007\Element\AbstractElement $writer Type hint */
