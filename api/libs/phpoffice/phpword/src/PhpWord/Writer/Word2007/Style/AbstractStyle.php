...
namespace lib\phpoffice\phpword\src\PhpWord\Writer\Word2007\Style;
...
abstract class AbstractStyle
{
     ...
     *
     * @var string|\lib\phpoffice\phpword\src\PhpWord\Style\AbstractStyle
     */
    protected $style;
     ...
     * @param string|\lib\phpoffice\phpword\src\PhpWord\Style\AbstractStyle $style
     */
     ...
     * Get Style
     *
     * @return string|\lib\phpoffice\phpword\src\PhpWord\Style\AbstractStyle
     */
    ...
    {
        if ($value !== null) {
            $class = 'lib\\phpoffice\\PhpWord\\Writer\\Word2007\\Style\\' . $name;

            /** @var \lib\phpoffice\phpword\src\PhpWord\Writer\Word2007\Style\AbstractStyle $writer */
