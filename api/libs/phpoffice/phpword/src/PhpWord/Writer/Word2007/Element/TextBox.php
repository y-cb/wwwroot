...
use lib\phpoffice\phpword\src\PhpWord\Writer\Word2007\Style\TextBox as TextBoxStyleWriter;
...
class TextBox extends Image
{
    ...
    public function write()
    {
        ...
        if (!$element instanceof \lib\phpoffice\phpword\src\PhpWord\Element\TextBox) {
            return;
        }
