...
abstract class AbstractElement
{
     ...
     * XML writer
     *
     * @var \lib\phpoffice\common\src\Common\XMLWriter
     */
    private $xmlWriter;
     ...
     * Element
     *
     * @var \lib\phpoffice\phpword\src\PhpWord\Element\AbstractElement
     */
    private $element;
     ...
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\AbstractElement $element
     * @param bool $withoutP
     */
     ...
     * Get element
     *
     * @return \lib\phpoffice\phpword\src\PhpWord\Element\AbstractElement
     */
     ...
     *
     * @uses \lib\phpoffice\phpword\src\PhpWord\Writer\Word2007\Element\PageBreak::write()
     */
    ...
    private function writeTextStyle($styleType)
    {
        ...
        $class = "lib\\phpoffice\\PhpWord\\Writer\\Word2007\\Style\\{$styleType}";
        $styleObject = $this->element->$method();

        /** @var \lib\phpoffice\phpword\src\PhpWord\Writer\Word2007\Style\AbstractStyle $styleWriter Type Hint */
