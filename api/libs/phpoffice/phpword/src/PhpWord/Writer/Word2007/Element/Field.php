...
class Field extends Text
{
    ...
    public function write()
    {
        ...
        if (!$element instanceof \lib\phpoffice\phpword\src\PhpWord\Element\Field) {
            return;
        }
    ...
    private function writeDefault(\lib\phpoffice\phpword\src\PhpWord\Element\Field $element)
    {
        ...
        if ($element->getText() != null) {
            if ($element->getText() instanceof \lib\phpoffice\phpword\src\PhpWord\Element\TextRun) {
     ...
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\Field $element
     */
    protected function writeMacrobutton(\lib\phpoffice\phpword\src\PhpWord\Element\Field $element)
    {
        $xmlWriter = $this->getXmlWriter();
        $this->startElementP();
    ...
    private function buildPropertiesAndOptions(\lib\phpoffice\phpword\src\PhpWord\Element\Field $element)
    {
