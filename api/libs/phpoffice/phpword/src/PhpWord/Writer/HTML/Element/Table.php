...
namespace lib\phpoffice\phpword\src\PhpWord\Writer\HTML\Element;
...
class Table extends AbstractElement
{
    ...
    {
        if (!$this->element instanceof \lib\phpoffice\phpword\src\PhpWord\Element\Table) {
            return '';
        }
     ...
     *
     * @param string|\lib\phpoffice\phpword\src\PhpWord\Style\Table|null $tableStyle
     * @return string
     */
    private function getTableStyle($tableStyle = null)
    {
        ...
        if (is_string($tableStyle)) {
            ...
            $style = ' style="';
            if ($tableStyle->getLayout() == \lib\phpoffice\phpword\src\PhpWord\Style\Table::LAYOUT_FIXED) {
                $style .= 'table-layout: fixed;';
            } elseif ($tableStyle->getLayout() == \lib\phpoffice\phpword\src\PhpWord\Style\Table::LAYOUT_AUTO) {
