...
use lib\phpoffice\phpword\src\PhpWord\Writer\HTML\Element\Container;
use lib\phpoffice\phpword\src\PhpWord\Writer\HTML\Element\TextRun as TextRunWriter;
...
class Body extends AbstractPart
{
    ...
    {
        /** @var \Plib\phpoffice\phpword\src\PhpWord\Writer\HTML $parentWriter Type hint */
