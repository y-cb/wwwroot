...
use lib\phpoffice\phpword\src\PhpWord\Element\Section;
...
class PhpWord
{
     ...
     *
     * @var \lib\phpoffice\phpword\src\PhpWord\Element\Section[]
     */
    ...
    public function __construct()
    {
        ...
        foreach ($collections as $collection) {
            $class = 'lib\\phpoffice\\phpword\\src\\PhpWord\\Collection\\' . $collection;
        ...
        foreach ($metadata as $meta) {
            $class = 'lib\\phpoffice\\phpword\\src\\PhpWord\\Metadata\\' . $meta;
    ...
    public function __call($function, $args)
    {
        ...
        if (in_array($function, $addCollection)) {
            ...
            /** @var \lib\phpoffice\phpword\src\PhpWord\Collection\AbstractCollection $collectionObject */
        ...
        if (in_array($function, $addStyle)) {
            return forward_static_call_array(array('lib\\phpoffice\\PhpWord\\Style', $function), $args);
        }
     ...
     *
     * @return \lib\phpoffice\phpword\src\PhpWord\Metadata\DocInfo
     */
     ...
     * Get protection
     *
     * @return \lib\phpoffice\phpword\src\PhpWord\Metadata\Protection
     * @since 0.12.0
     ...
     * Get compatibility
     *
     * @return \lib\phpoffice\phpword\src\PhpWord\Metadata\Compatibility
     * @since 0.12.0
     */
     ...
     * Get compatibility
     *
     * @return \lib\phpoffice\phpword\src\PhpWord\Metadata\Settings
     * @since 0.14.0
     */
     ...
     * Get all sections
     *
     * @return \lib\phpoffice\phpword\src\PhpWord\Element\Section[]
     */
     ...
     *
     * @param int $index
     * @return \lib\phpoffice\phpword\src\PhpWord\Element\Section|null
     */
     ...
     * @deprecated 0.12.0
     *
     * @param \lib\phpoffice\phpword\src\PhpWord\Metadata\DocInfo $documentProperties
     *
     * @return self
     *
     * @codeCoverageIgnore
