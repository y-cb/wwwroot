...
use lib\phpoffice\phpword\src\PhpWord\ComplexType\FootnoteProperties;
use lib\phpoffice\phpword\src\PhpWord\Style\Section as SectionStyle;
...
class Section extends AbstractContainer
{
    ...
    private function addHeaderFooter($type = Header::AUTO, $header = true)
    {
        ...
        if (in_array($type, array(Header::AUTO, Header::FIRST, Header::EVEN))) {
            ...
            /** @var \lib\phpoffice\phpword\src\PhpWord\Element\AbstractContainer $container Type hint */
