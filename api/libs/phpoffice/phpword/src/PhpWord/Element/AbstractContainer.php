 ...
 *
 * @method \lib\phpoffice\phpword\src\PhpWord\Element\OLEObject addObject(string $source, mixed $style = null) deprecated, use addOLEObject instead
 *
 * @since 0.10.0
 */
abstract class AbstractContainer extends AbstractElement
{
     ...
     *
     * @param int $index
     * @return \lib\phpoffice\phpword\src\PhpWord\Element\AbstractElement|null
     */
     ...
     *
     * @param int|\lib\phpoffice\phpword\src\PhpWord\Element\AbstractElement $toRemove
     */
    public function removeElement($toRemove)
    {
        ...
        } elseif ($toRemove instanceof \lib\phpoffice\phpword\src\PhpWord\Element\AbstractElement) {
     ...
     * @param mixed $paragraphStyle
     *
     * @return \lib\phpoffice\phpword\src\PhpWord\Element\Footnote
     *
     * @codeCoverageIgnore
     */
