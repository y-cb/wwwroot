...
namespace lib\phpoffice\phpword\src\PhpWord\Reader;
...
class Word2007 extends AbstractReader implements ReaderInterface
{
    ...
    {
        $partClass = "lib\\phpoffice\\PhpWord\\Reader\\Word2007\\{$partName}";
        if (class_exists($partClass)) {
            /** @var \lib\phpoffice\phpword\src\PhpWord\Reader\Word2007\AbstractPart $part Type hint */
