...
use lib\phpoffice\common\src\Common\Text;
use lib\phpoffice\common\src\Common\XMLWriter;
use lib\phpoffice\phpword\src\PhpWord\Escaper\RegExp;
use lib\phpoffice\phpword\src\PhpWord\Escaper\Xml;
use lib\phpoffice\phpword\src\PhpWord\Exception\CopyFileException;
use lib\phpoffice\phpword\src\PhpWord\Exception\CreateTemporaryFileException;
use lib\phpoffice\phpword\src\PhpWord\Exception\Exception;
use lib\phpoffice\phpword\src\PhpWord\Shared\ZipArchive;

/**
 * Class TemplateProcessor
 *
 * @package lib\phpoffice\phpword\src\PhpWord
 */
class TemplateProcessor
{
     ...
     *
     * @throws \lib\phpoffice\phpword\src\PhpWord\Exception\CreateTemporaryFileException
     * @throws \lib\phpoffice\phpword\src\PhpWord\Exception\CopyFileException
     */
     ...
     *
     * @return \lib\phpoffice\phpword\src\PhpWord\Shared\ZipArchive
     */
    public function zip()
    {
    ...
    /**
     * @param string $search
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\AbstractElement $complexType
     */
    public function setComplexValue($search, \lib\phpoffice\phpword\src\PhpWord\Element\AbstractElement $complexType)
    {
        $elementName = substr(get_class($complexType), strrpos(get_class($complexType), '\\') + 1);
        $objectClass = 'lib\\phpoffice\\PhpWord\\Writer\\Word2007\\Element\\' . $elementName;

        $xmlWriter = new XMLWriter();
        /** @var \lib\phpoffice\phpword\src\PhpWord\Writer\Word2007\Element\AbstractElement $elementWriter */
     ...
     * @param \lib\phpoffice\phpword\src\PhpWord\Element\AbstractElement $complexType
     */
    public function setComplexBlock($search, \lib\phpoffice\phpword\src\PhpWord\Element\AbstractElement $complexType)
    {
        $elementName = substr(get_class($complexType), strrpos(get_class($complexType), '\\') + 1);
        $objectClass = 'lib\\phpoffice\\PhpWord\\Writer\\Word2007\\Element\\' . $elementName;
     ...
     * @return \lib\phpoffice\phpword\src\PhpWord\TemplateProcessor Fluent interface
     */
