<?php
namespace lib;
use lib\CAS\CAS_Client;
use lib\CAS\CAS_TypeMismatchException;
use lib\CAS\CAS_InvalidArgumentException;
use lib\CAS\CAS_Exception;
use lib\CAS\CAS_GracefullTerminationException;
/**
...
class phpCAS
{
    ...
    */
    ...
    public static function logout($params = "")
    {
        ...
        $redirect = self::$_PHPCAS_CLIENT->logout($parsedParams);
        // never reached
        phpCAS :: traceEnd();
        return $redirect;
    }
